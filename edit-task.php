    ...
    <div class="container">
        ...
        <form method="POST" action="process.php" id="taskForm">
            ...
            <div class="btn-group">
                ...
                <a href="process.php?action=delete&id=<?php echo $task['id']; ?>" class="btn btn-danger" onclick="return confirmDelete(<?php echo $task['id']; ?>, '<?php echo htmlspecialchars($task['title']); ?>')">🗑️ Deletar Tarefa</a>
            </div>
        </form>
